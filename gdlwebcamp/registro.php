...
<section class="seccion contenedor">
    ...
    <form id="registro" class="registro" action="validar_registro.php" method="post">
        ...
        <div class="paquetes" class="paquetes">      
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        <div class="orden">
                            ...
                            <input type="numero" min="0" id="camisa_evento" name="pedido_camisas" size="10" placeholder="0">
                        </div><!--.orden-->
                        <div class="orden">
                            <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(HTML5, CSS3, JavaScript, Chrome)</small></label>
                            <input type="numero" min="0" id="etiquetas" name="pedido_etiquetas" size="10" placeholder="0">
                        </div><!--.orden-->
                        <div class="orden">
